...
#[derive(Debug)]
pub struct TatumSdkProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TatumSdkProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TatumSdk processing");
    
    let mut processor = TatumSdkProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TatumSdkProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TatumSdkProcessor::new(false);
